...
class OffenceClassification(Base):
    ...
    cognizable: Mapped[str] = mapped_column(String(100), nullable=False)
    bailable: Mapped[str] = mapped_column(String(100), nullable=False)
    triable_court: Mapped[str] = mapped_column(String(255), nullable=False)
